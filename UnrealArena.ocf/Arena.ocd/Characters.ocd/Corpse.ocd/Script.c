...
local FxInterpolateVertices = new Effect
{
	Start = func (bool temp)
	{
		...
		var y_14 = [4,  2,  8,  4,  0,  4,  4,  6,  6];
		var y_15 = [5,  0,  7,  5,  2,  5,  4,  6,  6]; //
		var y_16 = [5,  2,  5,  5,  5,  5,  5,  5,  5];
		var y_17 = [6,  2,  6,  6,  6,  6,  6,  6,  6];
		var y_18 = [7,  3,  8,  6,  6,  7,  7,  7,  7];
		var y_19 = [7,  4,  9,  6,  6,  7,  7,  8,  8];
		...
		var vertices_y = [y_00, y_00, y_00, y_00, y_00, y_00, y_00, y_07, y_08, y_09, y_10, y_11, y_12, y_13, y_14, y_15, y_16, y_17, y_18, y_19, y_20, y_20];
