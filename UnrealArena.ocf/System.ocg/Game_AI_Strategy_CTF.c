...
func SelectBotStrategy_CaptureTheFlag(object bot)
{
...
func GetEnemyFlagCarrier(int player)
{
...
func GetFriendlyFlagCarrier(int player)
{
	// The flag...
	for (var flag in FindObjects(Find_ID(GetFlagID()))) 
	{
...
func GetFriendlyFlag(int player)
{
	// The flag...
	for (var flag in FindObjects(Find_ID(GetFlagID()))) 
	{
...
func GetOwnFlagBase(int player)
{
	// The flag...
	for (var flag in FindObjects(Find_ID(GetFlagID()))) 
	{
