...
//public func RuleConflict(){ return [ ID_Rule_ClassSelection, ID_Rule_ExtraSelection, NOAM, WPST, ID_Rule_FastBullets ];}
public func RuleForbid(){ return [ ID_Rule_ClassSelection, ID_Rule_ExtraSelection, NOAM, WPST, ID_Rule_FastBullets ];}
