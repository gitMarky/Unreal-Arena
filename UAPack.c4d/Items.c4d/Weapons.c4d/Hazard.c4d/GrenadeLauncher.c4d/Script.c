...
*/
public func Fire1() { LaunchGrenade(GREN, 90,GetUser()->~AimAngle( 5)+RandomX( -5, 5),1); }
public func Fire2() { LaunchGrenade(CGRN, 70,GetUser()->~AimAngle(10)+RandomX(-10,15),2); }
public func Fire3() { LaunchGrenade(NGRN, 80,GetUser()->~AimAngle( 5)+RandomX( -5, 5),3); }
public func Fire4() { LaunchGrenade(SGRN,100,GetUser()->~AimAngle( 5)+RandomX( -5, 5),4); }
public func Fire5() { LaunchGrenade(EGRN, 80,GetUser()->~AimAngle( 5)+RandomX( -5, 5),5); }
public func Fire6() { LaunchGrenade(LGRN, 80,GetUser()->~AimAngle( 5)+RandomX( -5, 5),6); }
